...
Run Mode:           HI_SPEED
Trace Vars:         QUEUE[0],SERVICE[ID[7]],SYSTEM[ID[7]],RATIO[0],RATIO[3]
...
Name:             INIT
Description:      
State Changes:    SERVER[0]=3,SERVER[1]=2,QUEUE[0]=0,QUEUE[1]=0,ID[0]=-1,ID[1]=0,ID[2]=0,ID[3]=0,ID[4]=0,ID[5]=0,ID[6]=0,ID[7]=0,RATIO[0]=0,RATIO[1]=0,RATIO[2]=0,ID[9]=0,RATIO[3]=0,RATIO[4]=0,RATIO[5]=0
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
